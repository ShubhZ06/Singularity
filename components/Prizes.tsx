...
const prizes = [
    {
        ...
        title: 'Moon',
        prize: '$2,000',
        color: 'border-gray-300/35 hover:border-gray-300/90 transition-all duration-500',
    ...
    },
    {
        ...
        title: 'Sun',
        prize: '$5,000',
        color: 'border-gold-500/45 hover:border-gold-500/90 transition-all duration-500',
    ...
    },
    {
        ...
        title: 'Mars',
        prize: '$1,000',
        color: 'border-orange-700/50 hover:border-orange-700 transition-all duration-500',
        glow: 'shadow-[0_0_30px_rgba(184,115,51,0.3)]',
        bg: 'bg-gradient-to-b from-orange-900/20 to-black',
    },
];
